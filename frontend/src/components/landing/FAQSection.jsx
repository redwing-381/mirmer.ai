...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Free users get 10 queries per day. If you need more, you can upgrade to Pro for 100 queries per day at $19/month. Your query count resets daily, so you can always come back tomorrow!'
    }
  ]
