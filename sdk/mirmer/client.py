...
class Client:
    ...
    def __repr__(self) -> str:
        ...
        return f"Client(base_url='{self._base_url}', timeout={self._timeout})"

    def __str__(self) -> str:
        """Return string representation without exposing API key."""
        return f"Mirmer AI Client (base_url={self._base_url})"
    ...
    def query(
        ...
        for update in self.stream(message, conversation_id):
